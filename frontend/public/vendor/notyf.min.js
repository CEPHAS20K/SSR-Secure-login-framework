var Notyf = (function () {
  ...
  var r = {
    ...
    c =
      ...
      (p.prototype.removeNotification = function (t) {
        ...
        t &&
          ...
          e.addEventListener(
            ...
            (i = function (t) {
              t.target === e &&
                (e.removeEventListener(n.animationEndEventName, i), n.container.removeChild(e));
            })
          ));
      }),
      ...
      (p.prototype.getXPosition = function (t) {
        return (
          (null === (t = null == t ? void 0 : t.position) || void 0 === t ? void 0 : t.x) || "right"
        );
      }),
      (p.prototype.getYPosition = function (t) {
        return (
          (null === (t = null == t ? void 0 : t.position) || void 0 === t ? void 0 : t.y) ||
          "bottom"
        );
      }),
      ...
      (p.prototype._buildNotificationCard = function (n) {
        ...
        (i &&
          ...
          e.addEventListener("click", function (t) {
            var i, e;
            return null === (e = (i = o.events)[f.Click]) || void 0 === e
              ? void 0
              : e.call(i, { target: n, event: t });
          }));
  ...
  return (
    ...
    (d.prototype.normalizeOptions = function (t, i) {
      t = { type: t };
      return (
        "string" == typeof i ? (t.message = i) : "object" == typeof i && (t = o(o({}, t), i)),
        t
      );
    }),
