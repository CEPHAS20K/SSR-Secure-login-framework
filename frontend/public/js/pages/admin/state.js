...
export function normalizeDashboardDataModel(data) {
  ...
  return {
    ...
    quotas: { ...fallback.quotas, ...((data || {}).quotas || {}) },
    ...
    vaultStorageTrend: Array.isArray((data || {}).vaultStorageTrend) ? data.vaultStorageTrend : [],
    ...
    vaultUsage: Array.isArray((data || {}).vaultUsage) ? data.vaultUsage : [],
